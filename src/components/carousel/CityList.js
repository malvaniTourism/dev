                                ...
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            ...
                                            continent, being behind Asia in both. At about 30.3 million km²
                                            including adjacent islands, it 6% Earth's total surface area and
                                            20% land area.
                                        </p>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Thailand is the world's second largest and second most- populous
                                            continent, being behind Asia in both. At about 30.3 million km²
                                            including adjacent islands, it 6% Earth's total surface area and
                                            20% land area.
                                        </p>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Mexico is the world's second largest and second most- populous
                                            continent, being behind Asia in both. At about 30.3 million km²
                                            including adjacent islands, it 6% Earth's total surface area and
                                            20% land area.
                                        </p>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            France is the world's second largest and second most- populous
                                            continent, being behind Asia in both. At about 30.3 million km²
                                            including adjacent islands, it 6% Earth's total surface area and
                                            20% land area.
                                        </p>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Italy is the world's second largest and second most- populous
                                            continent, being behind Asia in both. At about 30.3 million km²
                                            including adjacent islands, it 6% Earth's total surface area and
                                            20% land area.
                                        </p>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Canada is the world's second largest and second most- populous
                                            continent, being behind Asia in both categories. At about 30.3
                                            million km² including adjacent islands, it 6% Earth's total
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Singapore is the world's second largest and second most-
                                            populous continent, being behind Asia in both. At about 30.3
                                            million km² including adjacent islands, it 6% Earth's total
                                            surface area and 20% land area.
                                        </p>
                                        <a className="btn btn-gray" href="destination-details.html">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Bangladesh is the world's second largest and second most-
                                            populous continent, being behind Asia in categories. At about
                                            30.3 million km² adjacent islands, it 6% Earth's total surface
                                            area and 20% land area.
                                        </p>
                                        <a className="btn btn-gray" href="destination-details.html">
                                            <span>
                                                Explore
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-destination-grid text-center">
                                    ...
                                    <div className="details">
                                        ...
                                        <p className="content">
                                            Dubai is the world's second largest and second most- populous
                                            continent, being behind Asia in both. At about 30.3 million km²
                                            including adjacent islands, it 6% Earth's total surface area and
                                            20% land area.
                                        </p>
